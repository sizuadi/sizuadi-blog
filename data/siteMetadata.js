...
const siteMetadata = {
  ...
  author: 'Sizu',
  headerTitle: 'Sizuadi',
  description: 'This is my personal blog about programming, my self, and my experiences.',
  language: 'id-ID',
  ...
  socialBanner: `${process.env.NEXT_PUBLIC_URL || ''}`,
  ...
  youtube: 'https://www.youtube.com/@sizuwano',
